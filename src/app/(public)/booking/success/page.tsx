  ...
  return (
    <div className="bg-black pt-28 text-white">
      <section className="page-container pb-20">
        <div className="mx-auto max-w-2xl rounded-[2rem] border border-[#d4af37]/30 bg-[#d4af37]/10 p-8 text-center">
          <div className="text-xs uppercase tracking-[0.28em] text-[#d4af37]">Request received</div>
