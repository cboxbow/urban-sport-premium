      ...
      <section className="page-container grid gap-8 py-8 lg:grid-cols-[1.15fr_0.85fr]">
        <div className="overflow-hidden rounded-[2rem] border border-white/8">
          <div className="relative h-[540px]">
            ...
            <div className="absolute bottom-0 left-0 p-8">
              <div className="text-xs uppercase tracking-[0.28em] text-[#d4af37]">{club?.name ?? tournament.clubSlug}</div>
        ...
        <div className="flex flex-col gap-6">
          <div className="rounded-[2rem] border border-white/8 bg-white/[0.03] p-6">
            <div className="text-xs uppercase tracking-[0.24em] text-[#d4af37]">Event overview</div>
          ...
          <div className="rounded-[2rem] border border-[#d4af37]/30 bg-[#d4af37]/10 p-6">
            <div className="text-xs uppercase tracking-[0.24em] text-[#d4af37]">Tournament status</div>
