  ...
  return (
    <div className="bg-black pt-28 text-white">
      <section className="page-container pb-10">
        <div className="text-xs uppercase tracking-[0.28em] text-[#d4af37]">Sponsor ecosystem</div>
      ...
      <section className="page-container grid gap-4 pb-12 md:grid-cols-4">
        {sponsors.metrics.map((item) => (
          <div key={item.label} className="surface-panel p-5">
            <div className="font-display text-5xl uppercase tracking-[0.1em] text-[#d4af37]">{item.value}</div>
      ...
      <section className="page-container grid gap-6 pb-12 lg:grid-cols-3">
        {sponsors.tiers.map((tier, index) => (
          <div key={tier.id} className={index === 0 ? 'rounded-[2rem] border border-[#d4af37]/30 bg-[#d4af37]/10 p-6' : 'surface-panel p-6'}>
            <div className="text-xs uppercase tracking-[0.24em] text-[#d4af37]">{tier.name}</div>
      ...
      <section className="page-container grid gap-6 pb-12 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="surface-panel p-6">
          <div className="text-xs uppercase tracking-[0.24em] text-[#d4af37]">Current partners</div>
        ...
        <div className="rounded-[2rem] border border-[#d4af37]/30 bg-[#d4af37]/10 p-8">
          <div className="text-xs uppercase tracking-[0.24em] text-[#d4af37]">Become a partner</div>
