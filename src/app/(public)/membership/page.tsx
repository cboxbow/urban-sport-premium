    ...
    <div className="bg-black pt-28 text-white">
      <section className="page-container pb-12">
        <div className="grid gap-8 xl:grid-cols-[1.08fr_0.92fr] xl:items-start">
          <div>
            <div className="text-xs uppercase tracking-[0.28em] text-[#d4af37]">Pricing</div>
            ...
            <div className="mt-8 grid gap-4">
              <article className="surface-panel p-6">
                <div className="text-xs uppercase tracking-[0.22em] text-[#d4af37]">Court hire</div>
              ...
              <article className="rounded-[1.75rem] border border-[#d4af37]/25 bg-[#d4af37]/8 p-6">
                <div className="text-xs uppercase tracking-[0.22em] text-[#d4af37]">Weekend advantage</div>
          ...
          <article className="premium-media-card overflow-hidden xl:sticky xl:top-32">
            <div className="border-b border-white/8 bg-black/40 px-5 py-5">
              <div className="text-xs uppercase tracking-[0.22em] text-[#d4af37]">Original pricing board</div>
            </div>
      ...
      <section className="page-container grid gap-6 pb-12 lg:grid-cols-2">
        {PACKAGES.map((plan) => (
          <article key={plan.name} className="surface-panel p-6 lg:p-7">
            <div className="text-xs uppercase tracking-[0.22em] text-[#d4af37]">{plan.name}</div>
      ...
      <section className="page-container grid gap-6 pb-12 lg:grid-cols-[0.8fr_1.2fr]">
        <article className="surface-panel p-6 lg:p-7">
          <div className="text-xs uppercase tracking-[0.22em] text-[#d4af37]">Yearly formulas</div>
          <div className="mt-5 grid gap-3">
            {YEARLY.map((item) => (
              <div key={item.label} className="flex items-center justify-between gap-4 rounded-[1.25rem] border border-white/10 bg-white/[0.03] px-4 py-4">
                <div className="text-sm uppercase tracking-[0.16em] text-white/55">{item.label}</div>
                <div className="text-xl font-semibold text-[#d4af37]">{item.value}</div>
              </div>
            ))}
          </div>
        </article>
        ...
        <article className="surface-panel p-6 lg:p-7">
          <div className="text-xs uppercase tracking-[0.22em] text-[#d4af37]">Club contacts</div>
          ...
          <div className="mt-6 rounded-[1.25rem] border border-[#d4af37]/22 bg-[#d4af37]/8 p-5">
            <div className="text-xs uppercase tracking-[0.16em] text-[#d4af37]">Booking access</div>
