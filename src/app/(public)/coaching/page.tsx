    ...
    <div className="bg-black pt-28 text-white">
      <section className="page-container grid gap-8 pb-12 lg:grid-cols-[1fr_0.92fr]">
        <div className="min-w-0">
          <div className="text-xs uppercase tracking-[0.28em] text-[#ffb300]">Coaching</div>
          ...
          <div className="mt-8 rounded-[1.75rem] border border-[#ffb300]/25 bg-[#ffb300]/8 p-6">
            <div className="text-xs uppercase tracking-[0.22em] text-[#ffb300]">{coaching.partnerLabel}</div>
        ...
        <div className="surface-panel overflow-hidden p-4 sm:p-5">
          <div className="relative h-[560px] rounded-[1.5rem] bg-black">
            <div className="absolute left-5 top-5 z-10 rounded-full border border-[#ffb300]/30 bg-black/60 px-4 py-2 text-xs uppercase tracking-[0.22em] text-[#ffb300] backdrop-blur-md">
              Coach with Sam
            </div>
            <video
      ...
      <section className="page-container pb-12">
        <div className="surface-panel p-6">
          <div className="text-xs uppercase tracking-[0.24em] text-[#ffb300]">What to expect</div>
      ...
      {coaching.coaches.length > 0 && (
        <section className="page-container pb-12">
          <div className="mb-6 text-xs uppercase tracking-[0.24em] text-[#ffb300]">Coaches</div>
              ...
              <article key={coach.id} className="premium-media-card overflow-hidden">
                <div className="grid gap-0 lg:grid-cols-[0.8fr_1.2fr]">
                  ...
                  <div className="p-6 lg:p-8">
                    <div className="text-xs uppercase tracking-[0.24em] text-[#ffb300]">{coach.location}</div>
                    ...
                    <div className="mt-6 rounded-[1.25rem] border border-[#ffb300]/25 bg-[#ffb300]/8 p-4">
                      <div className="text-xs uppercase tracking-[0.18em] text-[#ffb300]">Direct contact</div>
        ...
        {coaching.levels.map((level) => (
          <article key={level.id} className="premium-media-card overflow-hidden">
            <div className="grid gap-0 lg:grid-cols-[0.72fr_1.28fr]">
              ...
              <div className="p-6 lg:p-8">
                <div className="text-xs uppercase tracking-[0.24em] text-[#ffb300]">{level.levelRange}</div>
