  ...
  return (
    <div className="bg-black pt-28 text-white">
      <section className="page-container pb-10">
        <div className="text-xs uppercase tracking-[0.28em] text-[#ffb300]">Events and corporate</div>
      ...
      <section className="page-container grid gap-6 pb-12 lg:grid-cols-3">
        {events.eventTypes.map((item) => (
          <article key={item.id} className="surface-panel p-6">
            <div className="text-xs uppercase tracking-[0.24em] text-[#ffb300]">{item.title}</div>
      ...
      <section className="page-container grid gap-6 pb-12 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="surface-panel p-6">
          <div className="text-xs uppercase tracking-[0.24em] text-[#ffb300]">Why Urban Sport</div>
        ...
        <div className="surface-panel p-6">
          <div className="text-xs uppercase tracking-[0.24em] text-[#ffb300]">Inquiry form</div>
